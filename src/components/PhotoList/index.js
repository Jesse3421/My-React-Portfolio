...
import photo from '../../assets/projectPhoto';
...
function PhotoList({project}) {
    ...
    const selectedProject = projects.filter((project) => projects.project === category)
    return (
        <div>
        <div className="flex-row">
            {projects.map((image, i) => (
            <img 
            src={require(`../../assets/projectPhoto/${projects}/${i}.jpg`).default}
            alt={project.name}
